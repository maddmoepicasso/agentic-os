...
2. Your notes appear as a galaxy of stars. Click a star to see its connections, then click **Read memory** to open the note. Drag to spin the whole map.
...
## Explore the new spiral galaxy

This feature is already built. If you do not see it, update Agent OS; do not ask your AI to rebuild it.

- **Search** finds notes by title or folder path.
- **Explore** opens the memory list and folder filters. **This week** shows notes edited in the last seven days. **Unlinked** shows notes waiting for a connection.
- **Surprise me** picks a note from your current results.
- Click a star or a list item to highlight its linked notes. **Read memory** opens the original note.
- Use the pause, zoom, reset and expand buttons to change the view. Press Escape to leave expanded view and clear your selection.
- The stars you can select are your notes; the small background dust particles are decoration. Your computer's reduced-motion setting pauses automatic orbiting.

The pack includes no personal vault or example memories. You see your own notes once your vault is connected.
