...
## What you need
- An **OpenRouter key** — the same one Hermes and Fusion use. If you've set up `4-HERMES.md` or `17-EXTRA-MODELS.md`, you're already done. If not, get a key at <https://openrouter.ai> (a few dollars of credit goes a long way) and save it in `~/.hermes/.env` as `OPENROUTER_API_KEY=...`.
